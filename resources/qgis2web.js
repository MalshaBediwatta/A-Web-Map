...
map.getView().fit([8636854.137943, 649119.327318, 9344580.538227, 1111397.533663], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Web Map using GIS2Web Plugin</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (72 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows the main transportation routes and waterways in Sri Lanka';
            }

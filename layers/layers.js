...
lyr_OpenStreetMap_0.setVisible(true);lyr_SriLankaDistricts_1.setVisible(true);lyr_SriLankaRoads_2.setVisible(true);lyr_SriLankaWaterways_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_SriLankaDistricts_1,lyr_SriLankaRoads_2,lyr_SriLankaWaterways_3];
...
lyr_SriLankaRoads_2.set('fieldLabels', {'name': 'inline label - always visible', 'name_en': 'no label', 'highway': 'no label', 'surface': 'no label', 'smoothness': 'no label', 'width': 'inline label - always visible', 'lanes': 'no label', 'oneway': 'no label', 'bridge': 'no label', 'layer': 'no label', 'source': 'no label', 'name_si': 'no label', 'name_ta': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', });
